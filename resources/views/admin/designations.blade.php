                            ...
                            @if(count($department) > 0)
                                ...
                                @foreach($department as $dept)
                                    <tr>
                                        ...
                                        <th>
                                            <a href="#editEmployeeModal" class="edit editButton" data-id="{{$dept->id}}" data-name="{{$dept->designation}}" data-toggle="modal">
                    ...
                    <form id="addDesignation">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="designation" placeholder="Enter A Designation Name" required>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="editDesignation">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Degnation Name</label>
                                <input type="text" class="form-control" name="designation" value="" id="edit_deg_name">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
            ...
            $(document).ready(function(){
              ...
              $("#addDesignation").submit(function(event){
                ...
                $(".editButton").click(function(){
                    $('#edit_deg_id').val($(this).attr('data-id'));
                    $('#edit_deg_name').val($(this).attr('data-name'));
                });

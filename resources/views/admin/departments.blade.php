                            ...
                            @if(count($department) > 0)
                                ...
                                @foreach($department as $dept)
                                    <tr>
                                        ...
                                        <th>
                                            <a href="#editEmployeeModal" class="edit editButton" data-id="{{$dept->id}}" data-name="{{$dept->dept_name}}" data-toggle="modal">
                    ...
                    <form id="AddDepartment">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="dept_name" placeholder="Enter A Department Name" required>
                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="editDepartment">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="hidden" class="form-control" value=""  name="id" id="edit_dept_id">
                            </div>
                            <div class="form-group">
                                <label>Department Name</label>
                                <input type="text" class="form-control" name="dept_name" value="" id="edit_dept_name">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form id="deleteDepartment">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="hidden" class="form-control" value=""  name="dept_id" id="delete_dept_id">
                                </div>
            ...
            $(document).ready(function(){
              /* ---------------------Add------------------------- */
                ...
                $(".editButton").click(function(){
                    ...
                    $('#edit_dept_name').val($(this).attr('data-name'));
                });
                ...
                $(".deleteButton").click(function(){
                    $('#delete_dept_id').val($(this).attr('data-id'));
                });
                $("#deleteDepartment").submit(function(event){
                    
                    event.preventDefault();
                   
                    var form = $('#deleteDepartment')[0];
                    var data = new FormData(form);

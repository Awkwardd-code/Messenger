...
<body>
	...
	<!-- <div class="contact1">
	   ...
	   <!-- Login Modal -->
	   			<div class="modal fade" id="exampleResetPassModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		...
		<div class="container-contact1">
			...
			<div class="contact1-form validate-form">
				<form id="Reset_Password">
                    ...
                    <div class="wrap-input1 validate-input" data-validate = "Name is required">
						<input class="input1" type="hidden" name="id" value="{{$user[0]['id']}}">
						<span class="shadow-input1"></span>
					</div> 
					<div class="wrap-input1 validate-input" data-validate = "Name is required">
					...
					<div class="wrap-input1 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input1" type="password" name="password_confirmation" placeholder="Enter Your Confirm Password">
						<span class="shadow-input1"></span>
					</div>
					...
					<div class="container-contact1-form-btn1">
						<button type="submit" data-bs-toggle="modal" data-bs-target="#exampleResetPassModal" class="contact1-form-btn" id="BtnResetPass">
							<span>
								Reset Password
								<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
							</span>

		...
		<div class="container-contact1">
			...
			<div class="contact1-form validate-form">
						...
						<span class="contact1-form-title">
							Varification Is  On Process!!....
						</span>
						<p class="poseidon">Mr. {{Auth::user()->name}}, <br> We are varifying your details. Please stay with us . <br> We will get to you through an email.</p>

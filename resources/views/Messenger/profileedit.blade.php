                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                        ...
                        <a class="dropdown-item preview-item">
                            ...
                            <div class="preview-item-content">
                                <h6 class="preview-subject font-weight-normal"><a href="/messages">New Message</a></h6>
                                ...
                                <div class="col-md-12 mt-4 grid-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form id="updataProfile" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" class="form-control"  name="id" value="{{ $LoggedUserInfo->id }}" required>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{ $LoggedUserInfo->phone }}" required>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="form-group">
                                                            @if($LoggedUserInfo->image)
                                                                <img src="{{ asset('uploads/students/'  . $LoggedUserInfo->image) }}" alt="Profile Picture" class="img-fluid rounded" style="width: 150px; height: 150px;">
                                                            @else
    ...
    <!-- <script>
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $("#updataProfile").submit(function(event){
                    
                    event.preventDefault();
                
                    var form = $('#updataProfile')[0];
